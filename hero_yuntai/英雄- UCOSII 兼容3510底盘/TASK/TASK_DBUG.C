...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser = 0;
		ANO_DT_Send_Senser(Gimbal_DATA.real_centric_angle[4],Gimbal_DATA.real_centric_angle[5],key_x,
		MPU6050_Real_Data.Gyro_X,MPU6050_Real_Data.Gyro_Y,MPU6050_Real_Data.Gyro_Z,
		Gimbal_DATA.centric_angle[4],Gimbal_DATA.centric_angle[5],Rammer_Moto_Speed,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
	//上位机无法显示
	else if(f.send_rcdata)
	{
		Rc_Pwm_In[0]=MPU6050_Real_Data.Gyro_X;
		Rc_Pwm_In[1]=MPU6050_Real_Data.Gyro_Y;
		Rc_Pwm_In[2]=MPU6050_Real_Data.Gyro_Z;
...
/////////////////////////////////////////////////////////////////////////////////////	
	...
	{
		f.send_motopwm = 0;
		ANO_DT_Send_MotoPWM(RC_Ctl.rc.ch0,RC_Ctl.rc.ch1,RC_Ctl.rc.ch2,RC_Ctl.rc.ch3,limit_pitch_up,limit_pitch_down,limit_yaw_left,limit_yaw_right);
	}
/////////////////////////////////////////////////////////////////////////////////////
