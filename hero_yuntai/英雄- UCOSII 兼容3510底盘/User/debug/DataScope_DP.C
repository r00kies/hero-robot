...
//extern float KP,KI,KD,g_speed,g_adc_val,g_set_speed;
...
{
//			DataScope_Get_Channel_Data( g_speed, 1 ); //将数据 1.0  写入通道 1
//      DataScope_Get_Channel_Data( KP , 2 ); //将数据 2.0  写入通道 2
//      DataScope_Get_Channel_Data( KI , 3 ); //将数据 3.0  写入通道 3
//      DataScope_Get_Channel_Data( KD , 4 ); //将数据 4.0  写入通道 4
//		  DataScope_Get_Channel_Data( g_adc_val, 5 ); //将数据 5.0  写入通道 5
//      DataScope_Get_Channel_Data( g_set_speed , 6 ); //将数据 6.0  写入通道 6
