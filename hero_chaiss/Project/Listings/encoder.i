...
void Encoder_Configuration(void)
{
    ...
    gpio.GPIO_Pin = ((uint16_t)0x0020) | ((uint16_t)0x0010);
    gpio.GPIO_Speed = GPIO_Speed_2MHz;
	  gpio.GPIO_Mode = GPIO_Mode_IPU;
	  GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),&gpio);
    TIM_EncoderInterfaceConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), 
	                            ((uint16_t)0x0003),
							                ((uint16_t)0x0002),
							                ((uint16_t)0x0002));
...
void Encoder_Start(void)
{
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT = 0x7fff;
}

int Encoder_Get_CNT(void)
{
    int cnt = 0;
    cnt = (((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT)-0x7fff;
    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400))->CNT = 0x7fff;
    return cnt;
}
