...
void CAN_Configuration(void)
{
    uint16_t std_id =0x200,mask=0x0ff; 
	CAN_InitTypeDef        can;
	...
	can.CAN_TXFP = ENABLE;		
 	can.CAN_Mode = ((uint8_t)0x00);
	can.CAN_SJW = ((uint8_t)0x00);
	can.CAN_BS1 = ((uint8_t)0x04);
	can.CAN_BS2 = ((uint8_t)0x02);
	can.CAN_Prescaler = 4;     
	CAN_Init(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)), &can);
    
	can_filter.CAN_FilterNumber = 0;
	can_filter.CAN_FilterMode = ((uint8_t)0x00);
	can_filter.CAN_FilterScale = ((uint8_t)0x01);
	can_filter.CAN_FilterIdHigh = std_id<<5;;
	can_filter.CAN_FilterIdLow = 0|((uint32_t)0x00000000);
...
static uint8_t Mode_Chioce_flage=0;
static short int Value_H,Value_L,Value;
void USB_LP_CAN1_RX0_IRQHandler(void)
{
 
      CanRxMsg rx_message;    
	  uint32_t Mode_date,ID_date;
	  short int Speed_Value_H,Speed_Value_L,Speed_Value;
    ...
    if (CAN_GetITStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000002))!= RESET) 
	{
        ...
        if(rx_message.StdId==0x200)
        {
            ...
            case 0x33:
                Value=Value_H<<8|Value_L;
                Moto_Drive.Speed_Value=Value;break;
                case 0x22:    break;
                case 0x44:   break;
            }
           return;  
		 ...
		 if(rx_message.StdId==0x300)
		 {
				   ...
				   {
					 case 0x11:
							((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CCR4=0;
							((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CCR3=0;
      						TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), DISABLE); break;
					 case 0x33:
                            Value_H=rx_message.Data[1];
                            Value_L=rx_message.Data[2];
                            Value=Value_H<<8|Value_L;
                            Moto_Drive.PWM_Value =Value;
						    PID_Moto_Drive.Ouput_deltaUk_Max=Moto_Drive.Pwm_Max;
						    PID_Moto_Drive.Ouput_deltaUk_Min=-Moto_Drive.Pwm_Max;
                            Moto_Drive.Speed_Value=0;
      						TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), ENABLE);break;					 
					 case 0x22:   break;	
					 case 0x44:   break;	
				   }
					  return;
...
{
    if (CAN_GetITStatus(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000001))!= RESET) 
	{
	   CAN_ClearITPendingBit(((CAN_TypeDef *) (((uint32_t)0x40000000) + 0x6400)),((uint32_t)0x00000001));
