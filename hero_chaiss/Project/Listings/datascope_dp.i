#line 1 "..\\User\\debug\\DataScope_DP.C"
...
#line 3 "..\\User\\debug\\DataScope_DP.C"
unsigned char DataScope_OutPut_Buffer[42] = {0};	   
	unsigned char i;          
	unsigned char Send_Count; 
 float KP,KI,KD,g_speed,g_adc_val,g_set_speed;
...
void DataScope_Output(void)
{
			DataScope_Get_Channel_Data( g_speed, 1 ); 
      DataScope_Get_Channel_Data( KP , 2 ); 
      DataScope_Get_Channel_Data( KI , 3 ); 
      DataScope_Get_Channel_Data( KD , 4 ); 
		  DataScope_Get_Channel_Data( g_adc_val, 5 ); 
      DataScope_Get_Channel_Data( g_set_speed , 6 ); 
  	    ...
  	    ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))->DR = DataScope_OutPut_Buffer[i]; 
		  }
}
