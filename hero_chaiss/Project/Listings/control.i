...
void PID_Init(PID_Struct *PID)
{
  ...
  PID->Ti				   = 1.1;           
  PID->Td				   = 0.0;           
  PID->Ouput_deltaUk       = 0.0;		    
  PID->Ouput_deltaUk_Max   = 5000;		    
  PID->Ouput_deltaUk_Min   = -5000;		    
  PID->PID_Integral_Max    = 3000.0;		     
  PID->PID_Integral_Min    = -3000.0;			
}

void pid_init_struct(void)
{
	PID_Init(&PID_Power_Struct);
