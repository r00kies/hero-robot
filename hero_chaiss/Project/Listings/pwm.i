...
void PWM_Configuration()
{
  ...
  RCC_APB2PeriphClockCmd(((uint32_t)0x00000001), ENABLE);
	...
	TIM_OCInitSturcture.TIM_OCMode = ((uint16_t)0x0060);
  TIM_OCInitSturcture.TIM_OutputState = ((uint16_t)0x0001);
  TIM_OCInitSturcture.TIM_Pulse =1;
  TIM_OCInitSturcture.TIM_OCPolarity = ((uint16_t)0x0000);


	TIM_OC3Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), &TIM_OCInitSturcture);
	TIM_OC4Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), &TIM_OCInitSturcture);
	 
	TIM_CtrlPWMOutputs(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)),ENABLE);          
...
void SetMotorVoltage(float f_tVal)
{
	...
	if(f_tVal>0)
	{		
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CCR3=f_tVal;
  ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CCR4=0;
	}
	else
	{
	((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CCR4=-f_tVal;
