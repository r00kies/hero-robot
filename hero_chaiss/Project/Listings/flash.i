...
extern uint16_t VirtAddVarTab[((uint8_t)57)];
...
uint16_t InitCurrWrAddress(void)
{
  ...
  uint16_t ValidPage = ((uint16_t)0x0000);
  ...
  {
    CurWrAddress = (uint32_t)(((uint32_t)0x08010000) + (uint32_t)(ValidPage * (uint16_t)0x400));
  ...
  PageEndAddress = (uint32_t)((((uint32_t)0x08010000) - 2) + (uint32_t)((1 + ValidPage) * (uint16_t)0x400));

   
  while (CurWrAddress < PageEndAddress)
  {
     
    if ((*(volatile uint32_t*)CurWrAddress) == 0xFFFFFFFF)
    {
...
uint16_t __EE_Init(void)
{
  ...
  PageStatus0 = (*(volatile uint16_t*)((uint32_t)(((uint32_t)0x08010000) + 0x000)));
   
  PageStatus1 = (*(volatile uint16_t*)((uint32_t)(((uint32_t)0x08010000) + (uint16_t)0x400)));
  ...
  switch (PageStatus0)
  {
    case ((uint16_t)0xFFFF):
      if (PageStatus1 == ((uint16_t)0x0000))  
      {
        ...
        FlashStatus = FLASH_ErasePage(((uint32_t)(((uint32_t)0x08010000) + 0x000)));
      ...
      else if (PageStatus1 == ((uint16_t)0xEEEE))  
      {
        ...
        FlashStatus = FLASH_ProgramHalfWord(((uint32_t)(((uint32_t)0x08010000) + (uint16_t)0x400)), ((uint16_t)0x0000));
    ...
    case ((uint16_t)0xEEEE):
      if (PageStatus1 == ((uint16_t)0x0000))  
      {
        ...
        for (VarIdx = 0; VarIdx < ((uint8_t)57); VarIdx++)
        {
          if (( *(volatile uint16_t*)(((uint32_t)(((uint32_t)0x08010000) + 0x000)) + 6)) == VirtAddVarTab[VarIdx])
          {
            x = VarIdx;
          }
          if (VarIdx != x)
        ...
        FlashStatus = FLASH_ProgramHalfWord(((uint32_t)(((uint32_t)0x08010000) + 0x000)), ((uint16_t)0x0000));
        ...
        FlashStatus = FLASH_ErasePage(((uint32_t)(((uint32_t)0x08010000) + (uint16_t)0x400)));
    ...
    case ((uint16_t)0x0000):
      ...
      else  
      {
        ...
        for (VarIdx = 0; VarIdx < ((uint8_t)57); VarIdx++)
        {
          if ((*(volatile uint16_t*)(((uint32_t)(((uint32_t)0x08010000) + (uint16_t)0x400)) + 6)) == VirtAddVarTab[VarIdx])
          {
            x = VarIdx;
          }
          if (VarIdx != x)
...
uint16_t EE_ReadVariable(uint16_t VirtAddress, uint16_t* Data)
{
  ...
  PageStartAddress = (uint32_t)(((uint32_t)0x08010000) + (uint32_t)(ValidPage * (uint16_t)0x400));
...
static uint16_t EE_PageTransfer(uint16_t VirtAddress, uint16_t Data)
{
  ...
  uint16_t ValidPage = ((uint16_t)0x0000), VarIdx = 0;
  uint16_t EepromStatus = 0, ReadStatus = 0;
  ...
  if (ValidPage == ((uint16_t)0x0001))        
  {
    ...
    NewPageAddress = ((uint32_t)(((uint32_t)0x08010000) + 0x000));

     
    OldPageAddress = ((uint32_t)(((uint32_t)0x08010000) + (uint16_t)0x400));
  }
  else if (ValidPage == ((uint16_t)0x0000))   
  {
     
    NewPageAddress = ((uint32_t)(((uint32_t)0x08010000) + (uint16_t)0x400));

     
    OldPageAddress = ((uint32_t)(((uint32_t)0x08010000) + 0x000));
  }
  else
  {
    return ((uint16_t)0x00AB);        
