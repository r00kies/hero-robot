...
#line 15 "..\\Mylib\\DEBUG.c"
#line 16 "..\\Mylib\\DEBUG.c"
#line 17 "..\\Mylib\\DEBUG.c"
#line 18 "..\\Mylib\\DEBUG.c"
#line 19 "..\\Mylib\\DEBUG.c"
...
void ANO_DT_Data_Exchange(void)
{
	...
	{
		f.send_status = 0;
		ANO_DT_Send_Status(Moto_Drive.Measured_Speed,Moto_Drive.power,Q_angle.z,0,0,fly_ready);
	}	
	...
	{
		f.send_motopwm = 0;
		ANO_DT_Send_MotoPWM(0,1,2,3,4,5,6,7);
	}
	...
	else if(f.send_pid1)
	{
		...
		ANO_DT_Send_PID(1,PID_Moto_Drive.Kp,PID_Moto_Drive.Ti,PID_Moto_Drive.Td,
				  Moto_Drive.Can_id,Moto_Drive.encoder_dir,Moto_Drive.moto_dir,
	...
	{
		f.send_pid2 = 0;
		ANO_DT_Send_PID(2,Moto_Drive.Speed_Value/100,Moto_Drive.limit_power/100,PID_Roll_P_Struct.Td,
...
void ANO_DT_Send_Data(uint8_t *dataToSend , uint8_t length)
{
	...
	USART1_Send_Date(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),dataToSend , length );
...
void ANO_DT_Data_Receive_Prepare(uint8_t data)
{
	static volatile uint8_t RxBuffer[50];
...
void ANO_DT_Send_Version(uint8_t hardware_type, uint16_t hardware_ver,uint16_t software_ver,uint16_t protocol_ver,uint16_t bootloader_ver)
{
	...
	data_to_send[_cnt++]=( *( (char *)(&hardware_ver) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&hardware_ver) ) );
	data_to_send[_cnt++]=( *( (char *)(&software_ver) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&software_ver) ) );
	data_to_send[_cnt++]=( *( (char *)(&protocol_ver) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&protocol_ver) ) );
	data_to_send[_cnt++]=( *( (char *)(&bootloader_ver) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&bootloader_ver) ) );
...
void ANO_DT_Send_RCData(uint16_t thr,uint16_t yaw,uint16_t rol,uint16_t pit,uint16_t aux1,uint16_t aux2,uint16_t aux3,uint16_t aux4,uint16_t aux5,uint16_t aux6)
{
	...
	data_to_send[_cnt++]=0;
	data_to_send[_cnt++]=( *( (char *)(&thr) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&thr) ) );
	data_to_send[_cnt++]=( *( (char *)(&yaw) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&yaw) ) );
	data_to_send[_cnt++]=( *( (char *)(&rol) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&rol) ) );
	data_to_send[_cnt++]=( *( (char *)(&pit) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&pit) ) );
	data_to_send[_cnt++]=( *( (char *)(&aux1) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&aux1) ) );
	data_to_send[_cnt++]=( *( (char *)(&aux2) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&aux2) ) );
	data_to_send[_cnt++]=( *( (char *)(&aux3) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&aux3) ) );
	data_to_send[_cnt++]=( *( (char *)(&aux4) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&aux4) ) );
	data_to_send[_cnt++]=( *( (char *)(&aux5) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&aux5) ) );
	data_to_send[_cnt++]=( *( (char *)(&aux6) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&aux6) ) );
...
void ANO_DT_Send_Power(uint16_t votage, uint16_t current)
{
	...
	temp = votage;
	data_to_send[_cnt++]=( *( (char *)(&temp) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&temp) ) );
	temp = current;
	data_to_send[_cnt++]=( *( (char *)(&temp) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&temp) ) );
...
void ANO_DT_Send_MotoPWM(uint16_t m_1,uint16_t m_2,uint16_t m_3,uint16_t m_4,uint16_t m_5,uint16_t m_6,uint16_t m_7,uint16_t m_8)
{
	...
	data_to_send[_cnt++]=( *( (char *)(&m_1) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_1) ) );
	data_to_send[_cnt++]=( *( (char *)(&m_2) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_2) ) );
	data_to_send[_cnt++]=( *( (char *)(&m_3) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_3) ) );
	data_to_send[_cnt++]=( *( (char *)(&m_4) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_4) ) );
	data_to_send[_cnt++]=( *( (char *)(&m_5) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_5) ) );
	data_to_send[_cnt++]=( *( (char *)(&m_6) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_6) ) );
	data_to_send[_cnt++]=( *( (char *)(&m_7) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_7) ) );
	data_to_send[_cnt++]=( *( (char *)(&m_8) + 1) );
	data_to_send[_cnt++]=( *( (char *)(&m_8) ) );
