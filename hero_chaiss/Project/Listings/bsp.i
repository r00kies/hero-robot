...
uint16_t VirtAddVarTab[((uint8_t)57)] = {0xAA00, 0xAA01, 0xAA02, 0xAA03, 0xAA04, 0xAA05, 0xAA06, 0xAA07, 0xAA08, 0xAA09, 0xAA0A, 0xAA0B, 0xAA0C, 0xAA0D, 0xAA0E, 0xAA0F,
...
{
	uint16_t _temp;
	_temp = PID_Moto_Drive.Kp * 100;
	EE_WriteVariable(VirtAddVarTab[6],_temp);
	_temp = PID_Moto_Drive.Ti * 1000;
	EE_WriteVariable(VirtAddVarTab[7],_temp);
	_temp = Moto_Drive.Speed_Value * 100;
	EE_WriteVariable(VirtAddVarTab[8],_temp);
	_temp= Moto_Drive.Can_id;
	
	EE_WriteVariable(VirtAddVarTab[54],_temp);
	_temp=Moto_Drive.encoder_dir;
	EE_WriteVariable(VirtAddVarTab[55],_temp);
		_temp= Moto_Drive.moto_dir;
	EE_WriteVariable(VirtAddVarTab[56],_temp);
}
void EE_READ_PID(void)
{
	uint16_t _temp;
	EE_ReadVariable(VirtAddVarTab[6],&_temp);
	PID_Moto_Drive.Kp = (float)_temp / 100;
	EE_ReadVariable(VirtAddVarTab[7],&_temp);
	PID_Moto_Drive.Ti = (float)_temp / 1000;
	EE_ReadVariable(VirtAddVarTab[8],&_temp);
	Moto_Drive.Speed_Value = (float)_temp / 100;
	
	EE_ReadVariable(VirtAddVarTab[54],&_temp);
	Moto_Drive.Can_id=_temp;
	EE_ReadVariable(VirtAddVarTab[55],&_temp);
	Moto_Drive.encoder_dir=_temp;
	EE_ReadVariable(VirtAddVarTab[56],&_temp);
