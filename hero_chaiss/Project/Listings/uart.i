...
void USART1_Configuration(void)
{
    ...
    usart.USART_WordLength = ((uint16_t)0x0000);
    usart.USART_StopBits = ((uint16_t)0x0000);
    usart.USART_Parity = ((uint16_t)0x0000) ;
    usart.USART_Mode = ((uint16_t)0x0004) | ((uint16_t)0x0008);
    usart.USART_HardwareFlowControl = ((uint16_t)0x0000);   
    USART_Init(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),&usart);
		
		 USART_ITConfig(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0424),ENABLE);   
    ...
    dma.DMA_Priority = ((uint32_t)0x00003000);
    dma.DMA_M2M = ((uint32_t)0x00000000);
    DMA_Init(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),&dma);
...
void USART1_SendChar(char b)
{
	...
	USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),b);
}
...
{
    if(DMA_GetITStatus(((uint32_t)0x00020000)) == SET)
    {
        DMA_ClearFlag(((uint32_t)0x00020000));
        DMA_ClearITPendingBit(((uint32_t)0x00020000));
    }
}
void USART1_Send_Date( USART_TypeDef* USARTx, uint8_t *pWord, uint16_t Len )
{
	uint8_t i = 0;
	for(i=0; i<Len; i++) {
...
void USART1_IRQHandler(void)                               
{
	...
	if(USART_GetITStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)), ((uint16_t)0x0424)) != RESET)
    {
			TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), DISABLE);
    	temp = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->SR;
    	temp = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800))->DR;
    	DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),DISABLE);
	  	temp = 128 - DMA_GetCurrDataCounter(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)));
		for(i=0;i<temp;i++)
    ANO_DT_Data_Receive_Prepare(Uart1_Rx[i]);
		DMA_SetCurrDataCounter(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),128);
		DMA_Cmd(((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),ENABLE);
